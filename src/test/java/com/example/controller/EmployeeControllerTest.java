...
@Test
   public void testGetAllEmployees() throws Exception {
      ...
      mvc.perform(get("/api/employees/").contentType(APPLICATION_JSON)).andExpect(status().isOk())
   ...
   public void testGetEmployee() throws Exception {
      ...
      mvc.perform(get("/api/employee/" + employee.getEmpId()).contentType(APPLICATION_JSON)).andExpect(status().isOk())
